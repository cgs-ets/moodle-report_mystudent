...
define(['jquery', 'core/ajax', 'core/log', 'report_mystudent/chart'], function ($, Ajax, Log, Chart) {
    ...
    function init() {
        ...
        var control = new GradesAndEffortControl();
        control.main();
    }

    /**
     * GradesAndEffortControl a single report_mystudent block instance contents.
     *
     * @constructor
     */
    function GradesAndEffortControl() {
        let self = this;
    }
     ...
     *
     */
    GradesAndEffortControl.prototype.main = function () {
        let self = this;
    ...
    GradesAndEffortControl.prototype.trendChartSenior = function () {
    ...
    GradesAndEffortControl.prototype.trendChartPrimary = function () {
        const ctx = document.getElementById("trendChart");
        if (!ctx) {
            return;
        }
    ...
    GradesAndEffortControl.prototype.getEffortHistory = function () {
    ...
    GradesAndEffortControl.prototype.getGradeHistory = function () {
