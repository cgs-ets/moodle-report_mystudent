...
use function report_mystudent\grades_effort\get_performance_trend_context;
...
trait get_grade_effort_trend {
    ...
    public static  function get_grade_effort_trend_parameters() {
     ...
     * Return context.
     */
    public static function get_grade_effort_trend($username, $campus) {
        global $USER;
        ...
        self::validate_parameters(self::get_grade_effort_trend_parameters(), array('username' => $username, 'campus' => $campus));

        // Get the context for the grade history table template.

        $data = get_performance_trend_context($username, $campus);
     ...
     */
    public static function get_grade_effort_trend_returns() {
